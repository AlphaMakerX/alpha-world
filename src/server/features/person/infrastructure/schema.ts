...
export const users = pgTable(
  "users",
  {
    ...
    staminaCurrent: numeric("stamina_current", { precision: 10, scale: 2 }).notNull().default("1000"),
    staminaMax: numeric("stamina_max", { precision: 10, scale: 2 }).notNull().default("1000"),
