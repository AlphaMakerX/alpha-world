...
3. 配置 `ADAM_INITIAL_PASSWORD` 与 `BOT1_MANAGER_INITIAL_PASSWORD`
4. `npm run init:system` — 创建 Adam / Bot1 Manager 用户并初始化地图种子地块
...
| `BOT1_MANAGER_INITIAL_PASSWORD` | 系统初始化时 Bot1 Manager 的初始密码 |
